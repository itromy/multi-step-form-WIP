  ...
  return (
    <>
      <MultiStepForm step={1}>
        ...
        <TextInput onChange={onChange} name="name" value={formState.name} label="Name" placeholder="g.e. Stephen king" error={errorState.name}/> 
        <TextInput onChange={onChange} name="email" value={formState.email} label="Email Address" placeholder="g.e. Stephenking@lorem.com"  error={errorState.email}/> 
